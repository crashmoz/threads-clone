	...
	<div id="AuthPage" class="w-full h-[100vh] h-screen pt-32">
		<div class="w-full">
			...
			<div class="max-w-[350px] mx-auto px-2 text-white">
				...
				<button class="flex items-center justify-center gap-3 p-1.5 w-full border rounded-full text-lg font-semobild"
					@click="login('github')">
					<div class="flex items-center gap-2 justify-center">
						<img src="/github-logo.png" class="w-full max-w-[30px] rounded-full">Github
					</div>
				</button>
			</div>
		</div>
